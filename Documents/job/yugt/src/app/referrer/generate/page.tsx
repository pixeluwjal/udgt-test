...
export default function GenerateReferralPage() {
  ...
  // Redirect logic: Only job_referrers should access this page
  useEffect(() => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      // You NEED to implement the backend for this route (e.g., /app/api/referrer/generate-referral-code/route.ts)
      // and ensure it authorizes 'job_referrer' roles.
    ...
    <div className="flex h-screen bg-gradient-to-br from-blue-50 to-indigo-100 overflow-hidden font-inter">
      ...
      <div className="flex-1 flex flex-col overflow-y-auto">
        ...
        <div className="md:hidden bg-white shadow-sm p-4 flex justify-end items-center">
          <span className="text-lg font-bold text-teal-600">Referrer Panel</span> {/* Changed text */}
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-6">
          <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-lg border border-gray-100 p-6 md:p-8">
            <div className="flex justify-between items-center mb-6">
              ...
              <Link href="/referrer/dashboard" passHref> {/* Changed link target */}
                <button className="flex items-center px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors shadow-md transform hover:scale-105">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    autoComplete="email"
                    required
                    className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-all duration-200"
                    value={email}
              ...
              {error && (
                <div className="p-3 bg-red-100 border-l-4 border-red-500 rounded-r-lg shadow-sm" role="alert">
              ...
              {message && (
                <div className="p-3 bg-green-100 border-l-4 border-green-500 rounded-r-lg shadow-sm" role="alert">
                  <div className="flex items-center">
              ...
              {generatedCode && (
                <div className="bg-indigo-50 border border-indigo-200 text-indigo-800 p-4 rounded-lg shadow-sm">
