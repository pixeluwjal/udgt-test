...
useEffect(() => {
  ...
  switch (user.role) {
    case 'admin':
      if (!pathname.startsWith('/admin')) targetPath = '/admin/dashboard';
      break;
    case 'job_poster':
      if (!pathname.startsWith('/poster')) targetPath = '/poster/dashboard';
      break;
    case 'job_seeker':
      if (user.onboardingStatus === 'completed' && !pathname.startsWith('/seeker')) {
        targetPath = '/seeker/dashboard';
      } else if (user.onboardingStatus !== 'completed' && pathname !== '/seeker/onboarding') {
        targetPath = '/seeker/onboarding';
      }
      break;
    case 'job_referrer':
      if (!pathname.startsWith('/referrer')) targetPath = '/referrer/dashboard';
      break;
  }
