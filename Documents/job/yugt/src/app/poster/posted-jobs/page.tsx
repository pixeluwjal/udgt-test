  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden font-inter">
      ...
      <div className="flex-1 flex flex-col overflow-y-auto">
        {/* Mobile header (kept for responsiveness) */}
        <div className="md:hidden bg-white shadow-sm p-4 flex justify-between items-center">
          <span className="text-lg font-bold text-indigo-600">Posted Jobs</span>
        </div>
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-8">
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            {/* No Search and Filter Section needed */}
                  ...
                  {jobs.map((job) => (
                    <div key={job._id} className="px-6 py-5 hover:bg-gray-50 transition-colors duration-150">
                      <div className="flex items-start justify-between">
                        ...
                        {/* No "View" or "Delete" buttons needed */}
                      </div>
                    </div>
                  ))}
                </div>
